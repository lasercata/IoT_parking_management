...
\begin{document}
    ...
    \begin{indt}{\section{Design}} %{{{1
        ...
        \begin{indt}{\subsection{Mockup of the user interface}} %{{{2
            Below are the proposed mockup designs for both the user and administrator interfaces.
            All main pages of the platform are represented, including: the reservation page (user), user management interface (admin), node management interface (admin), home page (admin and user), login page (external), and password reset page (external).

            \begin{figure}[H]
                \centering
                \includegraphics[width=.75\textwidth]{pics/mockup1.png}
                \caption{Mockups part 1}
            \end{figure}

            \begin{figure}[H]
                \centering
                \includegraphics[width=.75\textwidth]{pics/mockup2.png}
                \caption{Mockups, part 2}
            \end{figure}
        \end{indt} %}}}2
