...
\begin{document}
    ...
    \begin{indt}{\section{Analysis}} %{{{1
            ...
            \begin{indt}{\subsubsection{Comparison of authorization verification technologies}} %{{{3
                ...
                \begin{table}[H]
                    ...
                    \begin{tabular}{p{60pt} p{55pt} p{55pt} p{60pt} p{55pt} p{45pt} p{38pt} p{55pt}}
                        ...
                        & \cellcolor{pastelGreen}   Token-based
            ...
            \begin{indt}{\subsubsection{Comparison of real-time notification solutions}} %{{{3
                ...
                \begin{table}[H]
                    ...
                    \begin{tabular}{p{60pt} p{55pt} p{55pt} p{60pt} p{55pt} p{45pt} p{38pt} p{55pt}}
                        ...
                        & \cellcolor{pastelGreen} TLS (WPA2/3)
                        & \cellcolor{pastelGreen} very low
                        \\
                        ...
                        & \cellcolor{pastelGreen} SIM-based
                        & \cellcolor{pastelOrange} medium
                        \\
                        ...
                        & \cellcolor{pastelOrange} AES-128
                        & \cellcolor{pastelGreen} low
                        \\
        ...
        \begin{indt}{\subsection{FR9 -- Parking spot status display}} %{{{2
            \begin{indt}{\subsubsection{Introduction}} %{{{3
                The objective of this functional requirement is to display the current status of a disabled parking space, namely whether it is \texttt{free}, \texttt{reserved}, or \texttt{occupied}. This information must be directly observable at the parking spot in order to guide users and support reservation enforcement.
            
                In the proposed IoT-based smart parking system, the parking spot status is derived from the aggregation of multiple data sources, including real-time occupancy detection at the node level and reservation information managed by the backend. The display mechanism must therefore provide a clear, reliable, and immediate representation of the system state, while remaining compatible with outdoor deployment constraints, low-power operation, and large-scale municipal rollout.
            \end{indt} %}}}3
            ...
            \begin{indt}{\subsubsection{Conclusion}} %{{{3
                Among the considered parking spot status display mechanisms, \textbf{multiple LEDs} provide the best compromise between \textbf{performance, reliability, durability, energy efficiency, portability, and affordability}. This solution fully satisfies the requirements of FR9 while remaining compliant with privacy constraints, as no personal or vehicle-related data is displayed.
            
                Display technologies such as segment LEDs and LCDs allow richer information to be presented, but they introduce higher power consumption, increased fragility in outdoor environments, and unnecessary complexity for a three-state status representation. E-paper displays, although energy-efficient, are unsuitable due to their slow refresh times, which conflict with the need for immediate feedback.
            
                \textbf{Multiple LEDs are therefore retained} as the preferred solution for implementing FR9, as they offer an immediate, intuitive, low-cost, and robust status indication well adapted to outdoor municipal deployment.
            \end{indt} %}}}3
