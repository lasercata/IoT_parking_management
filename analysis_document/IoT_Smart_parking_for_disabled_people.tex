    ...
    \begin{indt}{\section{Analysis}} %{{{1
        ...
        \begin{indt}{\subsection{FR3 -- Authorization cloning detection}} %{{{2
            ...
            \begin{indt}{\subsubsection{Comparison of cloning detection approaches}} %{{{3
                \begin{table}[H]% {{{4
                    ...
                    {\small
                    \begin{tabular}{p{3cm} p{50pt} p{50pt} p{50pt}}
                        \hline
                        \textbf{Approach}
                        & \textbf{Performan\-ce (NF1)}
                        & \textbf{Reliability (NF2)}
        ...
        \begin{indt}{\subsection{FR5 -- Authority notification}} %{{{2
            \begin{indt}{\subsubsection{Introduction}} %{{{3
                ...
                TODO: here maybe two tables are needed: one to compare the \emph{protocols} (e.g HTTP, MQTT, CoaP, ...), and one to compare the \emph{authority endpoint} (SMS, email, Discord, ...)
            \end{indt} %}}}3
        ...
        \begin{indt}{\subsection{User interface selection}} %{{{2
            TODO

            SMS, Discord, Email, WhatsApp, push notification on smartphone, ad hoc app
        \end{indt} %}}}2
    \end{indt} %}}}1
