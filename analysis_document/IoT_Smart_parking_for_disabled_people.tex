    ...
    \begin{indt}{\section{Design}} %{{{1
        ...
        \begin{indt}{\subsection{Node Automaton}} %{{{2
            \begin{figure}[H]
                ...
                \caption{State machine (automaton) of the hardware node}
                \label{fig:}
            \end{figure}
        \end{indt} %}}}2

        \begin{indt}{\subsection{Flow charts}} %{{{2
            \begin{indt}{\subsubsection{FR1}} %{{{3
                \begin{figure}[H]
                    \centering
            ...
            \begin{indt}{\subsubsection{FR2}} %{{{3
                \begin{figure}[H]
                    \centering
            ...
            \begin{indt}{\subsubsection{FR3}} %{{{3
                \begin{figure}[H]
                    \centering
            ...
            \begin{indt}{\subsubsection{FR4}} %{{{3
                \begin{figure}[H]
                    \centering
            ...
            \begin{indt}{\subsubsection{FR5}} %{{{3
                \begin{figure}[H]
                    \centering
            ...
            \begin{indt}{\subsubsection{FR6}} %{{{3
                \begin{figure}[H]
                    \centering
            ...
            \begin{indt}{\subsubsection{FR7}} %{{{3
                \begin{figure}[H]
                    \centering
            ...
            \begin{indt}{\subsubsection{FR8}} %{{{3
                \begin{figure}[H]
                    \centering
            ...
            \begin{indt}{\subsubsection{FR9}} %{{{3
                \begin{figure}[H]
                    \centering
            ...
            \begin{indt}{\subsubsection{FR10}} %{{{3
                \begin{figure}[H]
                    \centering
